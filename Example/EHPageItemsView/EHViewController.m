...
- (NSArray *)items {
    if (!_items) {
        _items = @[
                   @{@"title" : @"EHPageItemsView Label", @"class" : @"EHDemo1ViewController"},
                   @{@"title" : @"EHPageItemsView Button", @"class" : @"EHDemo2ViewController"},
                   @{@"title" : @"EHPageItemsView View", @"class" : @"EHDemo3ViewController"},
                   @{@"title" : @"EHPageItemsSelectionView Single Selection Custom Animation", @"class" : @"EHDemo4ViewController"},
                   ];
    }
