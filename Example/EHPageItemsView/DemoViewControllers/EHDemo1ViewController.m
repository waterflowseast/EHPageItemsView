...
@interface EHDemo1ViewController () <EHPageItemsViewDelegate>
...
- (void)configureForNavigationBar {
    self.navigationItem.title = @"EHPageItemsView Label";
}
